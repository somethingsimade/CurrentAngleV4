...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("Event"):WaitForChild("Ragdoll"):WaitForChild("ChangeRagdollState"):FireServer()
...
local UpperArmOffset = CFrame.new(0, 0.316, 0)
local LowerArmOffset = CFrame.new(0, -0.276, 0)
local HandOffset = CFrame.new(0, -0.875, 0)

local UpperLegOffset = CFrame.new(0, 0.45, 0)
local LowerLegOffset = CFrame.new(0, -0.1525, 0) 
local FootOffset = CFrame.new(0, -0.76, 0)

local UpperTorsoOffset = CFrame.new(0, 0.1, 0)
local LowerTorsoOffset = CFrame.new(0, -0.825, 0)

local HeadOffset = CFrame.new(0, 0, 0)
