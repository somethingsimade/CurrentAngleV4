...
TextLabel.Text = "WARNING: THIS GAME WILL GET YOU BANNED PERMANENTLY FOR USING THIS"
...
TextLabel_2.Text = "ARE YOU SURE YOU WANT TO CONTINUE?"
...
repeat task.wait() until chose == true
