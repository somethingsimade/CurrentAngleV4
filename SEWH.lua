...
local function LoadUi()
	...
	TextLabel_2.Text = [[Version made for "something evil will happen"]]
...
local obj = game:GetService("ReplicatedStorage"):WaitForChild("Communication"):WaitForChild("EventObjects"):WaitForChild("Asynchronous")
obj.Parent = nil
